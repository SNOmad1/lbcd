...
func (stats *Estimator) EstimateFee(targetConfs int32) (btcutil.Amount, error) {
	stats.lock.RLock()
...
func (stats *Estimator) ProcessBlock(block *btcutil.Block) error {
	stats.lock.Lock()
	defer stats.lock.Unlock()
